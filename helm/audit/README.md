...
=======
>>>>>>> 0332797e (Add cronjob and update audit/values.yaml)
...
| externalSecrets | map | `{"auditG3auto":null,"createK8sAuditSecret":false,"dbcreds":null,"pushSecret":false}` | External Secrets settings. |

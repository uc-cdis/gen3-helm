...
>>>>>>> ab9a5ede (Update gen3-workflow version)
=======
...
>>>>>>> a21aca21 (Update IAM role in gen3-workflow crossplane.yaml (#468))
=======
...
>>>>>>> d7adb420 (Improve gen3-workflow to run out of the box)
=======
...
>>>>>>> f9570c4e (MIDRC-1228 gen3-workflow AbortMultipartUpload access (#533))

...
| image | map | `{"pullPolicy":"Always","repository":"quay.io/cdis/workspace-token-service","tag":"feat_wts_internalfence","utilImage":"quay.io/cdis/utilities:master"}` | Docker image information. |

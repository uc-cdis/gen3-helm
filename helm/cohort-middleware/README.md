...
| externalSecrets | map | `{"cohortMiddlewareG3Auto":null,"enable":false}` | External Secrets settings. |
...
| externalSecrets.enable | bool | `false` | Whether or not to deploy external secrets as part of this release |

...
| externalSecrets | map | `{"sheepdogSmDbcreds":null}` | External Secrets settings. |
| externalSecrets.sheepdogSmDbcreds | string | `nil` | Will override the name of the aws secrets manager secret. Default is "Values.global.environment-.Chart.Name-creds" |

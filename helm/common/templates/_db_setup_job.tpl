      ...
      - name: db-setup
        ...
        args:
          - |
            ...
            PGPASSWORD=$SERVICE_PGPASS
            if psql -d $SERVICE_PGDB -h $PGHOST -p $PGPORT -U $SERVICE_PGUSER -c "\conninfo"; then
              gen3_log_info "Successful login into service database"
            ...
            echo "database does not exist or missing authorization"

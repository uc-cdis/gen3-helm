...
Usage: python yaml_merge.py file1.yaml file2.yaml ... amanuensis-config.yaml

Example: python yaml_merge.py file1.yaml file2.yaml amanuensis-config.yaml
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print("Usage: python yaml_merge.py config-file1.yaml config-file2.yaml ... amanuensis-config.yaml")
        sys.exit(1)

...
def inject_creds_into_presigned-url-fence_config(creds_file_path, config_file_path):
    ...
    config_file = _replace(config_file, "INDEXD_USERNAME", "presigned-url-fence")
...
def set_prod_defaults(config_file_path):
    ...
    print(
        ...
        "var/www/presigned-url-fence/presigned-url-fence_google_app_creds_secret.json"
    )
    config_file = _replace(
        config_file,
    ...
    print(
        ...
        "var/www/presigned-url-fence/presigned-url-fence_google_storage_creds_secret.json"
    )
    config_file = _replace(
        config_file,
...
def inject_other_files_into_presigned-url-fence_config(other_files, config_file_path):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="+",
        help="presigned-url-fence_credentials.json, local_settings.py, presigned-url-fence_settings.py file(s) to "
    ...
    inject_creds_into_presigned-url-fence_config(args.creds_file_to_inject, args.config_file)
    set_prod_defaults(args.config_file)

    if args.other_files_to_inject:
        inject_other_files_into_presigned-url-fence_config(

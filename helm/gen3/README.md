...
=======
![Version: 0.2.63](https://img.shields.io/badge/Version-0.2.63-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> f6af5a27 (Updating Ssjdispatcher SA Logic (#397))
=======
...
>>>>>>> 8b2498e7 (Fix envFrom for access-backend deployment)
=======
![Version: 0.2.70](https://img.shields.io/badge/Version-0.2.70-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> 1797f707 (Set apollo mode=production for guppy)
=======
...
>>>>>>> e9600ec9 (Allow devs to configure fence-jwt-keys with values.yaml)
=======
...
=======
![Version: 0.2.76](https://img.shields.io/badge/Version-0.2.76-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> a6ef146d (Increase SPARK_EXECUTOR_MEMORY and SPARK_DRIVER_MEMORY for ETL (#424))
=======
![Version: 0.2.78](https://img.shields.io/badge/Version-0.2.78-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> 1d9d5b3b (Adding Kubeconform Github Action. (#428))
=======
![Version: 0.2.79](https://img.shields.io/badge/Version-0.2.79-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> 8553e1fb (Close quote in es-proxy crossplane policy (#432))
=======
![Version: 0.2.80](https://img.shields.io/badge/Version-0.2.80-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> a6dcdb6f (update version)
=======
...
=======
![Version: 0.2.84](https://img.shields.io/badge/Version-0.2.84-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> c96cacf2 (set concurrencyPolicy: Forbid on cronjobs to prevent job buildup)
=======
![Version: 0.2.85](https://img.shields.io/badge/Version-0.2.85-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> ac4934b9 (Tag sower rpa with env and namespace like other crossplane resources (#441))
=======
...
=======
![Version: 0.2.88](https://img.shields.io/badge/Version-0.2.88-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
>>>>>>> 45aed67d (Update labeling for hpa template, add partOf to dashboard (#431))
=======
...
>>>>>>> fd4a8a32 (Fix YAML indentation in Gen3-workflow config)
=======
![Version: 0.2.91](https://img.shields.io/badge/Version-0.2.91-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: master](https://img.shields.io/badge/AppVersion-master-informational?style=flat-square)
...
| file://../ambassador | ambassador | 0.1.26 |
| file://../arborist | arborist | 0.1.25 |
| file://../argo-wrapper | argo-wrapper | 0.1.20 |
| file://../audit | audit | 0.1.31 |
| file://../aws-es-proxy | aws-es-proxy | 0.1.30 |
| file://../cedar | cedar | 0.1.13 |
| file://../cohort-middleware | cohort-middleware | 0.1.12 |
...
=======
>>>>>>> e62efc10 (Update gen3/values.yaml)

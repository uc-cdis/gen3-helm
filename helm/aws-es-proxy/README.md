...
| serviceAccount | map | `{"annotations":{"eks.amazonaws.com/role-arn":null},"create":true,"name":"es-proxy"}` | Service account to use or create. |
...
| serviceAccount.name | string | `"es-proxy"` | The name of the service account |

...
| env | list | `[{"name":"GEN3_DEBUG","value":"False"}]` | Environment variables to pass to the container |
...
| secrets | map | `{"userdb":{"fence":"test","gateway":null,"gdcapi":null}}` | Values for indexd secret. |
...
| volumes | list | `[{"configMap":{"name":"indexd-uwsgi"},"name":"uwsgi-config"},{"name":"config-volume","secret":{"secretName":"indexd-settings"}},{"name":"creds-volume","secret":{"secretName":"indexd-creds"}}]` | Volumes to attach to the pod |

...
*/}}
{{- define "gen3-user-data-library.name" -}}
...
*/}}
{{- define "gen3-user-data-library.fullname" -}}
...
*/}}
{{- define "gen3-user-data-library.chart" -}}
...
*/}}
{{- define "gen3-user-data-library.postgres.password" -}}
